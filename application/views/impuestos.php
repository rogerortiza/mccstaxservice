...
<html>
	...
	<body class="is-preload">
		...
		<!-- Header -->
			<header id="header">
				<h1><a href="index.html">MCCS Tax Service</a></h1>
				<nav id="nav">
					<ul>
						<li><a href="<?php 
                        site_url('welcome')
			...
			<section id="main" class="wrapper sidebar right">
				<div class="inner">
					...
					<header class="major">
						...
						<p>Realizamos tu declaración de impuestos de este año o años anteriores, somos un proveedor autorizado por el IRS.</p>
					</header>

					<!-- Content -->
						<div class="content">
							<a href="#" class="image fit"><img src="assets/images/money2.jpg" alt="" /></a>
							<h3>Dolore Amet Csdfdssdonsequat</h3>
